		...
		<div
			className={
				smallButton
					...
					: 'relative inline-flex items-center px-12 py-4 bg-[#00D4E5] overflow-hidden text-lg font-bold text-[#2E6A86] border-2 border-[#00D4E5] rounded-md hover:text-white hover:border-[#00D4E5]  group hover:bg-[#00D4E5]'
			}
		>
