					...
					<span>
						{address ? (
							<Link
								...
								target="_blank"
							>
								<div className="flex items-center border border-cyan-600 px-8 py-2 rounded-full text-cyan-600 hover:bg-gradient-to-r from-purple-200 via-cyan-50 to-cyan-200 transition ease-in-out hover:-translate-y-1 duration-100 cursor-pointer">
