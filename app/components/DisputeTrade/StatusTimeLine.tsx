...
const steps = [
	...
	{ name: 'Notify Mechant', description: 'Merchant has been notified', href: '#', status: 'current' },
	{ name: 'Merchant Response', description: 'Merchant is yet to respond', href: '#', status: 'upcoming' },
	{ name: 'Openpeer Arbitrary', description: 'Openpeer arbitrate the dispute', href: '#', status: 'upcoming' }
];
