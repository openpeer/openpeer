import { arbitrum, avalanche, gnosis, mainnet, optimism, polygon, polygonMumbai } from 'wagmi/chains';
...
export const productionChains = [polygon, mainnet, arbitrum, optimism, gnosis, avalanche, polygonMumbai];
