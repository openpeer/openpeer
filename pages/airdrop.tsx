...
import roundTree from '../airdrop/roundFourTree.json';
...
const CLOSED_ROUND = 4;
const ROUND = 5;
const POOL = 1000000;
const AIRDROP_START = 1698840000000;
const CHAIN = polygon;
...
const AirdropPage = () => {
	...
	const [activeTab, setActiveTab] = useState('TradeRewards');
			...
			<div className="flex justify-center">
				<div
					className={`px-4 py-2 cursor-pointer ${
						activeTab === 'TradeRewards' ? 'border-b-2 border-black font-bold' : ''
					}`}
					onClick={() => setActiveTab('TradeRewards')}
				>
					Trade Rewards
				</div>
				<div
					className={`px-4 py-2 cursor-pointer ${
						activeTab === 'Liquidityrewards' ? 'border-b-2 border-black font-bold' : ''
					}`}
					onClick={() => setActiveTab('Liquidityrewards')}
				>
					Liquidity Rewards
				</div>
			</div>
								...
								<div className="flex flex-col lg:flex-row lg:space-x-20 items-center">
									<div>
										...
										<div className="flex flex-col mb-4">
											...
											<span className="text-[#67738E] font-light">
												You will be rewarded with vP2P tokens based on your trade volume. This
												token will be convertible to our protocol&apos;s upcoming P2P token.
											</span>
										</div>
									</div>
									<div>
										<div className="flex flex-col mb-4">
											...
											<span className="text-[#67738E] font-light">
												Crypto sales between new users.
											</span>
										</div>
										<div className="flex flex-col mb-4">
											<span className="text-[#25385A] font-bold">
												How to collect your reward?
											</span>
											<span className="text-[#67738E] font-light">
												After the countdown hits zero and this month&apos;s epoch ends, the
												calculated reward will be available to redeem
											</span>
										</div>
									</div>
					...
					<div className="p-4 md:px-16 flex flex-col text-[#25385A]">
						<div className="w-full flex justify-between">
							<div className="flex flex-row items-center space-x-2">
								...
								<span className="text-lg">Liquidity Rewards</span>
							</div>
							<span>
								{address ? (
									<Link
						...
						<div className="mt-4 w-full rounded-xl p-[4px] bg-gradient-to-r from-[#3C9AAA] to-cyan-600">
							<div className="flex flex-col p-8 justify-center items-center h-full bg-[#F4F6FB] text-white rounded-lg text-gray-800">
								<div className="mb-4 font-light md:text-2xl text-center">Liquidity Rewards</div>
								<div className="w-full md:w-1/2 text-center text-base text-zinc-600">
									You can earn vP2P by locking funds in your escrow contracts and making them
									available for sale. Rewards are calculated based on the total amount you escrow and
									how long you have them available. Rewards are calculated weekly and distributed
									monthly.
								</div>
								<div className="w-full md:w-1/2 flex flex-col text-left my-8">
									<div className="flex flex-row justify-between mb-4">
										<div>Value currently in escrow</div>
										<div>
									...
									<div className="flex flex-row justify-between border-b mb-4 pb-4">
										...
										<div>
											<span className="text-2xl">3400</span>
											<span className="text-sm pl-2">vP2P</span>
										</div>
									</div>
									<div className="flex flex-row justify-between">
										<div>Total rewars available to claim</div>
										<div>
											<span className="text-2xl font-bold">55</span>
											<span className="text-sm pl-2 font-bold">vP2P</span>
										</div>
									</div>
								</div>
							</div>
